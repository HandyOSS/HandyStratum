...
class Job {
  ...
  setAttemptMask(attempt,mask){
    ...
    let maskChar = Math.floor(Math.random() * 14 + 1); //# between 1 and f
    mask = mask.substr(0,maskLocation) + maskChar.toString(16) + mask.substr(maskLocation+1);
    /*
    //leaving this in case you want to see how mask is placed between share and block targets
